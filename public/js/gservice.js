...
angular.module('gservice', [])
  .factory('gservice', function($rootScope, $http){
    ...
    // Selected location (initialize to center of klaten)
    var selectedLat = -7.739967;
    var selectedLong = 110.664568;
    ...
    var convertToMapPoints = function(response){
      ...
      for(var i=0; i < response.length; i++){
        ...
        var contentString = 
          '<p><b>Jeneng</b>: ' + user.username +
          '<br><b>umur</b>: ' + user.age +
          '<br><b>Gender</b>: ' + user.gender +
          '<br><b>boso favorite</b>: ' + user.favlang +
          '</p>';
